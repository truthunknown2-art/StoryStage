...
export const rookPilot001Direction: Readonly<Record<string, Omit<ShotOverride, "shotId">>> = {
  ...
  "1.03": {
    treatment: "generated-illustration",
    imageDirection: "Strasbourg in 1518: one adult woman dances alone near the left third of a wide cobblestone street while only a few distant townspeople notice on the right. Use a historically plausible early-16th-century Alsatian timber-framed setting, overcast uneasy daylight, and an original tactile editorial look with hand-painted cut-paper shapes, subtle screenprint grain, bold silhouettes, parchment cream, charcoal, muted umber, desaturated teal, and restrained vermilion. Leave depth for a slow camera push; no modern objects, horror, or anatomy distortion.",
    framing: "insert",
    transition: "hard-cut",
    cameraAction: "cameraPush",
  },
  "1.04": {treatment: "character-performance", framing: "close-up", transition: "hard-cut", cameraAction: "reframe"},
  "1.05": {
    treatment: "generated-illustration",
    imageDirection: "Strasbourg in 1518: the dancing episode has escalated into a genuine public emergency, with a layered crowd of exhausted dancers across the foreground and midground, anxious townspeople, and concerned civic observers at the edges of a historically plausible Alsatian square. Build a clear diagonal flow for a gentle pan in the same tactile cut-paper, hand-painted, subtly screenprinted editorial palette. Keep the tension humane rather than grotesque; no modern objects, horror, or anatomy distortion.",
    framing: "wide",
    transition: "hard-cut",
    cameraAction: "pan",
  },
  ...
  "1.08": {
    treatment: "generated-illustration",
    imageDirection: "Strasbourg in 1518: visualize the bizarre policy theory that exhausted dancers could dance the fever out. Weary dancers continue on a simple raised wooden stage centered left while period musicians play and worried civic officials observe at right. Use a historically plausible square and the same tactile cut-paper, hand-painted, subtly screenprinted editorial palette, with strong depth for a slow camera push. The mood is absurd bureaucratic confidence colliding with visible exhaustion, never slapstick or gore; no modern objects or anatomy distortion.",
    framing: "wide",
    transition: "hard-cut",
    cameraAction: "cameraPush",
  },

...
import { directorTimelineSchema } from "./director-timeline";
import {
  createKidsShowcaseDirectorTimeline,
  KIDS_SHOWCASE_DIRECTED_SHOTS,
} from "./kids-showcase-director-timeline";
...
const sceneDrafts = [
  {
    ...
    beats: [
      ...
      },
      {
        ...
        shotIds: ["shot-listen-in-the-dark"],
      },
    ],
  },
  {
...
const shotDrafts = [
  {
    ...
    motionChannels: [
      ...
      "visible-arch-crossing",
      "planted-threshold-foot",
    ],
  },
  {
    ...
    motionChannels: [
      ...
      "arm-gesture",
      "camera-push",
      "inherited-root-state",
      "visible-deceleration",
      "moth-crosses-threshold",
    ],
  },
  {
    ...
    motionChannels: [
      ...
      "cave-parallax",
      "visible-forest-arch",
      "continuous-moth-path",
      "planted-reveal-marks",
    ],
  },
  {
...
const kidsShowcaseProgramFields = {
  ...
  shotBindings: z.array(kidsShowcaseShotBindingSchema).length(10),
  directorTimeline: directorTimelineSchema,
...
export function createKidsShowcaseProgram(): KidsShowcaseProgram {
  ...
  const draft = {
    ...
    renderPlan,
    directorTimeline: createKidsShowcaseDirectorTimeline(
      hashCanonical(KIDS_SHOWCASE_SOURCE_SCRIPT),
    ),
    scenes,
    beats,
    shotBindings,

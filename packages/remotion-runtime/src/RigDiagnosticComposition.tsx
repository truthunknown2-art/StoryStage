...
export const RigDiagnosticComposition: React.FC<RigDiagnosticCompositionProps> = ({asset, entityName}) => {
  ...
  return <AbsoluteFill style={{background: "linear-gradient(145deg,#101718,#25332f)", color: "#edf3ef", fontFamily: "Arial, sans-serif", overflow: "hidden"}}>
    ...
    </> : asset.assetClass === "prop" ? <Img src={asset.cutout} style={{bottom: 90, height: 390, objectFit: "contain", position: "absolute", right: interpolate(frame, [0, 70, 119], [640, 420, 250]), rotate: `${interpolate(frame, [0, 60, 119], [-7, 5, 0])}deg`, translate: `0 ${interpolate(frame, [0, 55, 80, 119], [0, -90, -60, 0])}px`, width: 390}} /> : <>
      <Img src={asset.cutout} style={{height: "100%", objectFit: "cover", scale: interpolate(frame, [0, 119], [1, 1.1]), translate: `${interpolate(frame, [0, 119], [0, -30])}px 0`, width: "100%"}} />
      <div style={{border: "5px solid rgba(239,78,59,.84)", inset: 34, position: "absolute"}} />
    </>}

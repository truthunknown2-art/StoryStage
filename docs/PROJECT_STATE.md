...
- Gate 7 semantic Remotion animation: initial plan-driven 24-second slice with approved local voice/music/custom-SFX masters, deterministic two-pose timing-driven lip sync, shot-relative SFX placement, and hash-bound mix decisions is implemented and proven; phoneme/viseme sync, full episode coverage, and visual polish remain pending.
- Gate 8 review/override: shot overrides including asset-aware visual-treatment rerouting, real rendered transition direction, spoken cue retiming, asset selection/approval, a functional frame-accurate cut timeline, an editor-lockable narration/caption timing workspace, local WAV import/audition/approval, in-app playback of completed approved H.264 slices with synchronized shot/frame review, and evidence-backed production preflight exist; unrendered live Remotion preview, full-length playback, and broader performance controls remain incomplete.

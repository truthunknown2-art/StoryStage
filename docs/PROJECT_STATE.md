...
- Gate 4 provider-neutral manual ChatGPT Images exchange: immutable main-owned export, durable restart-safe job identity/lifecycle, exact disclosure review, authoritative Show Pack checks, structured-bundle import, loose-file role mapping, trusted-root containment, and byte-verified staging through a timed/capped utility process are locally verified. Full decode/metadata normalization, preparation/registration, visual identity validation, lineage, and approval UI remain pending.

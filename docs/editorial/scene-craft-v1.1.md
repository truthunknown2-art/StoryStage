...
- **Status:** Draft editorial knowledge base; non-normative until each rule is
  classified and its evidence is mapped.
...
- **Scope:** planning context, quality observations, capability requests, and
  blind editorial evaluation. This document does not grant production,
  preparation, rig, timing, render, or export authority.
...
director with a more elaborate rule-table director.

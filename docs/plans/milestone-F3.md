...
- Current authorization: only F3-WP1 through issue #72, after the separate
  status transition and Kimi Inbox Version 60 are integrated.
- Exact implementation base: `38969c4400e2a9c84a59346c28f7a72d5f9492bf`
- Required F3-WP1 branch: `agent/kimi-f3-wp1-scope-workspace-foundation`

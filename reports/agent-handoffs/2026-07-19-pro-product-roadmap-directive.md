# ChatGPT Pro product-roadmap directive — 2026-07-19
...
- **Accepted integration head:**
  `agent/kcast001-provider-neutral-rig@714d65ce80df2625b0b1ffc86ca52cc4cd8fe4e4`
- **Binding roadmap:** `docs/PRODUCT_ROADMAP.md`
...
- a UI control lacks an executable contract;
...
- a creator-visible milestone ends only in schemas/tests.

## Exact source handoffs

- `reports/agent-handoffs/2026-07-19-pro-codex-handoff.md`
- `reports/agent-handoffs/2026-07-19-pro-kimi-handoff.md`
- `reports/agent-handoffs/2026-07-19-pro-repo-update-manifest.md`

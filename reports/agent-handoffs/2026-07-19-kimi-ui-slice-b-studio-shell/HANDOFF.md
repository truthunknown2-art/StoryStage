...
- **Left:** Scenes and beats rail. Image-led cards whose thumbnails are canonical frames rendered from the sealed episode plan (`DirectorFrameThumbnail`), grouped by scene with role labels.
...
| Command | Result |
| --- | --- |
| `corepack pnpm --filter @storystage/studio test` | **79/79 passed (7 files)** |

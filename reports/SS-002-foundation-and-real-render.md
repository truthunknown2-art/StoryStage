...
- `pnpm verify`: privacy check, lint, all package typechecks, and 109 tests across fixtures, contracts, story-engine, desktop, asset-pipeline, studio, asset-worker, and render-worker
...
- public Show Pack candidate: Rook's original ChatGPT-generated identity sheet and three transparent poses are hash-bound, reproducibly normalized to 1600x1800, registered to a common ground line, validated through the production rig schema, and rendered into a 120-frame diagnostic without bypassing human approval
...
- The original Rook history-presenter candidate is generated, normalized, and diagnostic-ready but intentionally unapproved. Kids art, history backgrounds/editorial inserts, and a complete production-bound manual round trip remain open.

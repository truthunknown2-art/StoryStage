...
Put an actual show through the accepted StoryStage machinery. Carry the existing 26.33-second `Rook Pilot 001: The Dancing Plague Had a Payroll` from a directed, visibly incomplete first cut to a human-approved, reproducibly rendered, verified local delivery without inventing content or bypassing approval.
...
- After those gates are satisfied, render the exact saved revision twice, compare deterministic evidence, publish and reopen the verified delivery, and review the finished MP4 against the pilot quality rubric.

## Out of scope

New generic workflow UI, padding the script, automatic approval, credential or cookie storage, API-backed ChatGPT image generation, stock scraping, cloud publishing, a broad asset library, Kids production art, and Blender work not demanded by this pilot.

...
- Gate 7: an initial exact-plan Remotion path is implemented and proven with approved local pixels, pose changes, cuts, deterministic transition entrance treatment, camera movement, captions, guide audio, and SFX. The minimal workflow proof is 6.08 seconds; the renderer supports longer slices.
- Gate 8: shot overrides including real rendered transition direction and spoken cue retiming, asset review, a functional frame-accurate cut timeline with play/pause, scrubbing, shot jumps, synchronized inspector, an explicit narration/caption timing-lock workspace, evidence-backed preflight, and in-app playback of completed approved H.264 slices exist. Recorded voice binding, asset-aware visual-treatment rerouting, unrendered live Remotion preview, full-length playback, and the remaining inspector interactions are still open.

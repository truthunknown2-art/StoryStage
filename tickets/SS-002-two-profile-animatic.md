...
- Gate 7: an initial exact-plan Remotion path is implemented and proven with approved local pixels, profile-specific timing-driven mouth/pose changes, cuts, deterministic transition entrance treatment, camera movement, captions, an approved hash-bound WAV voice master, hash-bound mix decisions, and AAC output. The minimal workflow proof is 6.08 seconds; the renderer supports longer slices. Phoneme sync and imported music masters remain open.

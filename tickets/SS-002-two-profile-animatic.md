...
- Gate 7: an initial exact-plan Remotion path is implemented and proven with approved local pixels, profile-specific timing-driven mouth/pose changes, cuts, deterministic transition entrance treatment, camera movement, captions, separate approved hash-bound WAV voice/music masters, hash-bound gain/loop decisions, and AAC output. The minimal workflow proof is 6.08 seconds; the renderer supports longer slices. Phoneme sync and cue-placed custom SFX remain open.
- Gate 8: shot overrides including real rendered transition direction and spoken cue retiming, asset review, a functional frame-accurate cut timeline with play/pause, scrubbing, shot jumps, synchronized inspector, an explicit narration/caption timing-lock workspace, local WAV import/audition/approval, profile-aware mix review, evidence-backed preflight, and in-app playback of completed approved H.264 slices exist. Asset-aware visual-treatment rerouting, unrendered live Remotion preview, full-length playback, and the remaining inspector interactions are still open.
